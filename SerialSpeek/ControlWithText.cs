...
namespace SerialSpeak
{
    ...
    ************************************************************************/
    class ControlWithText
    {
        ...
        static string[] prgrmCmnd = {"end of line \t---- \tSortie du programme",
        ...
        static string[] serialInfo = {"Les caractèristiques du port série seront :",
                                     "Baud rate : \t9600",
                                     "Parity : \tnone",
                                     "Stop bits : \tOne",
                                     "Data bits : \t8",
        ...
        private static string acquireKeyboard()
        {
            ...
            while (true)
            {
                ...
                else if (charRead.Key == ConsoleKey.Escape) return "end of line";
                ...
                else if (charRead.Key == ConsoleKey.Backspace && i>0) i--;
                //Si la touche enfoncée est la flèche vers le haut
                else if (charRead.Key == ConsoleKey.UpArrow) return previousCmnd;
        ...
        public static void controlThroughLines()
        {
            ...
            switch (commandLine)
            {
                ...
                case "open serial":
                    ...
                    if (nomDuPort != "out") serie = PortSerieUser.setSerialPort(nomDuPort);
                    controlThroughLines();
                    break;
                ...
                case "set serial" :
                    ...
                    if (nameOfPort != "out") serie = PortSerieUser.setSerialPort(nameOfPort);
                    controlThroughLines();
                    break;
            ...
            lookForFiles :  //balise de retour
                    ...
                    if (userAnswer != "oui") goto lookForFiles; //si la réponse est différente de oui (on ne trouve pas ce...
                                                                //...que l'on souhaite) on renvoie à la balise de retour
                    else if (userAnswer == "out") controlThroughLines();
            ...
            if (AppliExcel.classeur != null)
            {
                try
                {
                    if (AppliExcel.lineNumber == 1)
                    {
                        ...
                        AppliExcel.lineNumber++; AppliExcel.columnNumber = 1;           //on descend d'une ligne et onn revient colonne 1
                    }
                    else
                    {
